		...
		while (state >= 0 && i < s.length()){
			...
			switch(state){
				...
				case 0: // stato iniziale
					if (48 <= ch && ch <= 57 || ch  == ' ') { // e' un numero o spazio
				...
				case 5:
					if (76 <= ch && ch <= 90 || 108 <= ch && ch <= 122) // L-Z
						state = 3;
					else if (65 <= ch && ch <= 75 || 97 <= ch && ch <= 107 || 48 <= ch && ch <= 57 || ch == ' ') // A-K oppure numero oppure spazio
						state = 4;
					else
						state = -1;
					break;
				...
				case 6:
					if (65 <= ch && ch <= 75 || 97 <= ch && ch <= 107) // A-K
						state = 3;
					else if (76 <= ch && ch <= 90 || 108 <= ch && ch <= 122 || 48 <= ch && ch <= 57 || ch == ' ') // L-Z oppure numero oppure spazio
						state = 4;
					else
						state = -1;
					break;
				...
				case 7:
					if (48 <= ch && ch <= 57 || ch == ' ') // numero oppure spazio
						state = 4;
					else if (65 <= ch && ch <= 90 || 97 <= ch && ch <= 122) // e' una lettera
						state = 3;
					else
