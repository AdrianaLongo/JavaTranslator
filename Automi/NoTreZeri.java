/* Esercizio 1.1
	Progettare e implementare il DFA che riconosca il linguaggio delle stringhe di 0 e 1 che non contengono tre zeri
	consecutivi.
*/
...
public class NoTreZeri{
	...
	// booleano a seconda che la stringa di input appartenga o meno al linguaggio riconosciuto dal DFA (o -1 se
	// legge un simbolo non contenuto nell'alfabeto del DFA)
	public static boolean scan(String s){
		...
		// effettua un cambiamento dello stato dell'automa (tramite un costrutto switch con tanti "case" quanti sono
		...
		return state == 0 || state == 1 || state == 2; // infatti case 0, 1 e 2 rappresentano gli stati accettanti
	}
